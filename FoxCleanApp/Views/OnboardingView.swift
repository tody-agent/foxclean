...
struct OnboardingView: View {
    ...
    private var introView: some View {
        VStack(spacing: 12) {
            Text("FoxClean needs Full Disk Access to uninstall apps, find leftover files, and clean protected caches.")
                .foregroundStyle(.secondary)
                .multilineTextAlignment(.center)
                .frame(maxWidth: 420)
    ...
    private var instructionsView: some View {
        VStack(spacing: 10) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                stepRow(number: 2, text: "Find **FoxClean** and turn the toggle on")
            ...
            HStack(spacing: 8) {
                ...
                Menu {
                    Button("FoxClean isn't in the list — reveal it") {
    ...
    private var grantedView: some View {
        VStack(spacing: 8) {
            ...
            Text("FoxClean can now manage protected files.")
                .font(.caption)
                .foregroundStyle(.secondary)
        }

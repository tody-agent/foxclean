    ...
    var body: some View {
        Form {
            Section("Startup") {
                ...
                Toggle("Show FoxClean in menu bar", isOn: $showMenuBar)
            }
            ...
            Section("Accessibility") {
                Toggle("Reduce Foxie animations", isOn: $reduceFoxieAnimations)
                Text("FoxClean also follows the macOS Reduce Motion setting.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
        }

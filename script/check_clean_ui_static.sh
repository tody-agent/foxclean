...
require_pattern FoxCleanApp/Logic/Scanning/AppInfoFetcher.swift 'let installDate: Date\?'
require_pattern FoxCleanApp/Logic/Scanning/AppInfoFetcher.swift 'let isSystemApp: Bool'
require_pattern FoxCleanApp/Logic/Scanning/AppInfoFetcher.swift 'let isProtected: Bool'
require_pattern FoxCleanApp/Views/Apps/AppListView.swift 'HSplitView'
require_pattern FoxCleanApp/Views/Apps/AppListView.swift 'Toggle\("Hide system apps"'
require_pattern FoxCleanApp/Views/Apps/AppListView.swift 'Toggle\("Hide protected apps"'
require_pattern FoxCleanApp/Views/Apps/AppListView.swift 'Slider\(value: \$sensitivity'
require_pattern FoxCleanApp/Views/Apps/AppListView.swift 'AppPathFinder\.Sensitivity'
require_pattern FoxCleanApp/Views/Apps/AppListView.swift 'scanForAppFiles\(app, sensitivity: appSensitivity\)'
...
require_pattern FoxCleanApp/Views/Apps/AppFilesView.swift 'Uninstall Completely'
require_pattern FoxCleanApp/Views/Apps/AppFilesView.swift 'confirmationDialog\('
...
require_pattern FoxCleanApp/Views/Orphans/OrphanListView.swift 'searchable\(text: \$searchText'
require_pattern FoxCleanApp/Views/Orphans/OrphanListView.swift 'Button\("Smart Select"\)'
require_pattern FoxCleanApp/Views/Orphans/OrphanListView.swift 'isSmartCandidate'
require_pattern FoxCleanApp/Views/Orphans/OrphanListView.swift 'confirmationDialog\('
